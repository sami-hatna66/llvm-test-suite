...
//
// RUN: env WRITE_DEVICE_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DEVICE_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_PLATFORM_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_PLATFORM_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_DEVICE_ERROR_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DEVICE_ERROR_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_PLATFORM_ERROR_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_PLATFORM_ERROR_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_REG_EX_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_REG_EX_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_DEVICE_NAME_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DEVICE_NAME_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_PLATFORM_NAME_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_PLATFORM_NAME_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_DEVICE_MULTI_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DEVICE_MULTI_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_DEVICE_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DEVICE_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_DRIVER_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_DRIVER_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_PLATFORM_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_PLATFORM_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// RUN: env WRITE_PLATVER_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
// RUN: env READ_PLATVER_MALFORMED_INFO=1 SYCL_DEVICE_FILTER=%u %t.out
//
// REQUIRES: gpu
